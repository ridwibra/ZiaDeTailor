    ...
    >
      ...
      >
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          {/* Success */}
          {forgotSuccess && (
            <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-800 text-sm">
              {forgotSuccess}
            </div>
          )}
        </form>
